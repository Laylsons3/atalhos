...
function Home() {
  ...
  function addCount100() {
    setCount(count + 100);
  }
  function addCount1000() {
    setCount(count + 1000);
  }
  function zerar() {
    setCount(0);
  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Atalhos para emissão das principais certidões negativas."
        />
        ...
        <meta
          property="og:image"
          content="https://atalhocnd.com.br/image.png"
        />
        ...
        <meta
          ...
          content="kQtiYuplM3IY350vq6CkuUxnxQnoQptbut6CpuhwXFk"
        />
      </Head>
      ...
      <div className="absolute text-xs right-20 flex gap-x-2">
        {count > 10000 && (
          <button
            className="bg-indigo-500 px-2 rounded text-white"
            onClick={addCount1000}
          >
            +1000
          </button>
        )}
        ...
        <button onClick={zerar}>{Number(count)}</button>
      </div>
            ...
            <div className="bg-green-700 col-span-1 py-2 rounded-lg text-green-50">
              ...
              <div className="my-2">
                ...
                >
                  <input
                    id="botao"
                    className="bg-green-300 hover:bg-green-400 rounded-md text-black py-1 w-32 hover:cursor-pointer"
                    type="button"
                    value="Emitir"
                  ></input>
                </a>
            ...
            <div className="bg-green-700 col-span-1 py-2 rounded-lg text-green-50">
              ...
              <div className="flex justify-center gap-1 my-2">
                ...
                >
                  <input
                    id="botao"
                    className="bg-green-300 hover:bg-green-400 rounded-md text-black py-1 w-16 hover:cursor-pointer"
                    type="button"
                    value="Emitir"
                  ></input>
                </a>
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://solucoes.receita.fazenda.gov.br/Servicos/certidaointernet/PJ/Autenticidade/Confirmar"
                >
                  <input
                    id="botao"
                    className="bg-red-300 hover:bg-red-400 rounded-md text-black py-1 w-16 hover:cursor-pointer"
                    type="button"
                    value="Validar"
                  ></input>
                </a>
            ...
            <div className="bg-green-700 col-span-1 py-2 rounded-lg text-green-50">
              ...
              <div className="flex justify-center gap-1 my-2">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://internet-consultapublica.apps.sefaz.ce.gov.br/certidaonegativa/preparar-consultar"
                >
                  <input
                    id="botao"
                    className="bg-green-300 hover:bg-green-400 rounded-md text-black py-1 w-16 hover:cursor-pointer"
                ...
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://internet-consultapublica.apps.sefaz.ce.gov.br/certidaonegativa/preparar-validacao"
                >
                  <input
                    id="botao"
                    className="bg-red-300 hover:bg-red-400 rounded-md text-black py-1 w-16 hover:cursor-pointer"
            ...
            <div className="bg-green-700 col-span-1 py-2 rounded-lg text-green-50">
              ...
              <div className="flex justify-center gap-1 my-2">
                ...
                >
                  <input
                    id="botao"
                    className="bg-cyan-300 hover:bg-cyan-400 rounded-md text-black py-1 w-32 hover:cursor-pointer"
                    type="button"
                    value="Emitir/Validar"
                  ></input>
                </a>
              </div>
            </div>
            ...
            <div className="bg-green-700 col-span-1 py-2 rounded-lg text-green-50">
              ...
              <div className="flex justify-center gap-1 my-2">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://autdoc.tjce.jus.br/"
                >
                  {/* Emitir */}
                  {/* https://sirece.tjce.jus.br/sirece-web/nova/solicitacao.jsf;jsessionid=WopYm2Wo1S5aryJJ5tqv2prAE2XFchMV7_HhXTuA.tjsrp03 */}
                  <input
                    id="botao"
                    className="bg-yellow-300 hover:bg-yellow-400 rounded-md text-black py-1 w-32 hover:cursor-pointer"
                    type="button"
                    value="Validar"
                  ></input>
                </a>
            ...
            <div className="bg-green-700 col-span-1 py-2 rounded-lg text-green-50">
              ...
              <div className="flex justify-center gap-1 my-2">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://crea-ce.sitac.com.br/app/view/sight/externo?form=ConsultarCertidaoSimples"
                >
                  <input
                    id="botao"
                    className="bg-yellow-300 hover:bg-yellow-400 rounded-md text-black py-1 w-32 hover:cursor-pointer"
            ...
            <div className="bg-green-700 col-span-1 py-2 rounded-lg text-green-50">
              ...
              <div className="flex justify-center gap-1 my-2">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://www9.anvisa.gov.br/peticionamento/sat/formularios/CertificadoCertidao/frmValidaCertidao.asp?sarea=GGTPS"
                >
                  <input
                    id="botao"
                    className="bg-yellow-300 hover:bg-yellow-400 rounded-md text-black py-1 w-32 hover:cursor-pointer"
            ...
            <div className="bg-green-700 col-span-1 py-2 rounded-lg text-green-50">
              ...
              <div className="flex justify-center gap-1 my-2">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://servicos.sefaz.ce.gov.br/internet/Sintegra/Sintegra.Asp?estado=CE"
                >
                  <input
                    id="botao"
                    className="bg-yellow-300 hover:bg-yellow-400 rounded-md text-black py-1 w-32 hover:cursor-pointer"
            ...
            <div className="bg-green-700 col-span-1 py-2 rounded-lg text-green-50">
              ...
              <div className="flex justify-center gap-1 my-2">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="http://www.sped.fazenda.gov.br/appConsultaSituacaoContabil/"
                >
                  <input
                    id="botao"
                    className="bg-yellow-300 hover:bg-yellow-400 rounded-md text-black py-1 w-32 hover:cursor-pointer"
            ...
            <div className="bg-green-700 col-span-1 py-2 rounded-lg text-green-50">
              ...
              <div className="flex justify-center gap-1 my-2">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://www.jucec.ce.gov.br/projeto/validar-documentos/"
                >
                  <input
                    id="botao"
                    className="bg-yellow-300 hover:bg-yellow-400 rounded-md text-black py-1 w-32 hover:cursor-pointer"
                  ...
                  <div>
                    {munFiltrados.map((municipio) => (
                      <Link key={municipio.nome} href={municipio.link}>
                        <a
                          target="_BLANK"
                          className="inline-flex text-md md:text-xl mb-1 px-1 mx-1 hover:underline hover:text-white text-gray-200"
                        >
                          {municipio.nome}
                        </a>
                      </Link>
      ...
      <footer className="text-[8pt] mr-2 mt-1 text-right">v1.3</footer>
    </div>
  );
}
